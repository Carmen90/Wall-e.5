...
public class Console extends java.lang.Object implements NavigationObserver, RobotEngineObserver, InventoryObserver {
	...
	/**
	 * Muestra por consola los elementos que tiene un determinado inventario
	 * @param inventoryDescription un string con todos los elementos del inventario
	 */
	@Override
	...
	/**
	 * Muestra por consola la descripción de un elemento en concreto 
	 * @param decription la descripción a mostrar
	 */
	@Override
